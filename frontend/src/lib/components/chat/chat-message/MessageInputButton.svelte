<script lang="ts">
	...
	const typeClassMap = {
		primary:
			"bg-button-bg-primary text-button-label-primary border-0 border-button-stroke-primary hover:bg-button-bg-primary/90",
		secondary:
			"bg-button-bg-secondary text-button-label-secondary border-0 border-button-stroke-secondary hover:bg-button-bg-secondary/90",
		danger: "bg-button-bg-destructive text-button-label-destructive border-0 border-button-stroke-destructive hover:bg-button-bg-destructive/90",
